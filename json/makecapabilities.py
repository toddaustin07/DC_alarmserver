#!/bin/python3
###########################################################################
# Copyright 2021 Todd A. Austin  Version 20210209
#
...
APICMD_createcapability = '/capabilities'
...
if TOKEN == 'Bearer xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx':
    print("\033[93mYou must first edit line 26 in this script to provide your SmartThings personal token\033[0m")
    exit(-1)

# Get list of files in the current directory

lsout = subprocess.run(["ls"], stdout=subprocess.PIPE,
    ...
    try:
        if fname[1] == "json":
            ...
            if tname[1] == "cap":
                ...
                r = requests.post(BASEURL+APICMD_createcapability, headers=headers, data=filejson)
                ...
                if r.status_code == HTTP_OK:
                    ...
                    try:
                        with open(capabilityID+'_cap.json',"w") as f2:
                        ...
                        if rc == 0:
                            ...
                            if rc == 0:
                                ...
                                if r.status_code == HTTP_OK:
                                    # Save returned json to file
                                    try:
                                        with open(capabilityID+'_pres.json',"w") as f2:
                                            f2.write(json.dumps(json.loads(r.text), indent=4))
                                    except:
